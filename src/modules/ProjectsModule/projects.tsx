...
export const cards: Card[] = [
...

  {
    ...
    ctaText2: "Details",
    ctaLink: [
      "https://book.azoresairlines.pt/booking/",
      "https://book.cyprusairways.com/booking/",
    ],
    ctaTexts: ["Azores Airlines", "Cyprus Airways"],
...

  {
    ...
    imageClassBig: "object-cover object-center scale-110",
    imageWellClass: "bg-black",
    content: (technologies: string[]) => {
      return (
        <div>
